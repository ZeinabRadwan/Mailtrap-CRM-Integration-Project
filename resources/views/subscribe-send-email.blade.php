...
<body>
    <!-- Add Tab Navigation -->
    <div class="container">
        <h2><i class="fas fa-paper-plane"></i> Send Email Campaign</h2>
        ...
        <!-- Tab Headers -->
        <ul class="tab-nav">
            <li class="tab-link active" onclick="openTab(event, 'tab-sender')">Sender Info</li>
            <li class="tab-link" onclick="openTab(event, 'tab-message')">Email Content & Recipients</li>
        </ul>

        <form method="POST" action="/subscribe-send-email" id="email-form2">
            @csrf

            <!-- Tab 1: Sender Info -->
            <div id="tab-sender" class="tab-content active">
                <label>From Name:</label>
                <input type="text" name="from_name" class="form-control" placeholder="Enter sender name" required>

                <label>From Email:</label>
                <input type="email" name="from_email" class="form-control" placeholder="Enter sender email" required>

                <button type="button" class="btn btn-next" onclick="openTab(event, 'tab-message')">Next</button>
            </div>

            <!-- Tab 2: Message + Recipients -->
            <div id="tab-message" class="tab-content">
                <div class="form-group">
                    <label for="email-subject">Email Subject:</label>
                    <input type="text" id="email-subject" name="subject" class="form-control"
                        placeholder="Enter email subject" required value="Message from Glary For Cloud Management">
                </div>
                ...
                <div class="toolbar">
                    ...
                    <button type="button" class="tool-btn" title="Strikethrough"
                    ...
                    <button type="button" class="tool-btn" title="Align Left"
                        onclick="document.execCommand('justifyLeft')">
                        <i class="fas fa-align-left"></i>
                    </button>
                    <button type="button" class="tool-btn" title="Align Center"
                        onclick="document.execCommand('justifyCenter')">
                        <i class="fas fa-align-center"></i>
                    </button>
                    <button type="button" class="tool-btn" title="Align Right"
    ...
    <script>
        ...
        document.getElementById('email-form2').onsubmit = function(event) {
        ...
        // Before submit, put editor content into hidden input
        document.getElementById("email-form2").addEventListener("submit", function() {
            const editorContent = document.getElementById("message-editor").innerHTML;
            document.getElementById("message-field").value = editorContent;
        });
    </script>
</body>
